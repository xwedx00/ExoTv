...
const DeletionPrivacy = () => {
  return (
    <Section className="space-y-8 pt-20">
      <Head title="Privacy - Exoexs" />

      <h1>Privacy Policy for Exoexs</h1>

      <p>
        At Exoexs, accessible from https://exoexs.com, one of our main
        priorities is the privacy of our visitors. This Privacy Policy document
        contains types of information that is collected and recorded by Exoexs
        and how we use it.
      </p>
      ...
      <p>
        Exoexs legal basis for collecting and using the personal information
      ...
      <ul>
        <li>Exoexs needs to perform a contract with you</li>
        <li>You have given Exoexs permission to do so</li>
        <li>
          Processing your personal information is in Exoexs legitimate interests
        </li>
        <li>Exoexs needs to comply with the law</li>
      </ul>

      <p>
        Exoexs will retain your personal information only for as long as is
      ...
      <p>
        Exoexs follows a standard procedure of using log files. These files log
      ...
      <p>
        Like any other website, Exoexs uses &apos;cookies&apos;. These cookies
      ...
      <p>
        ...
        advertising partners of Exoexs.
      </p>

      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on Exoexs, which are sent directly
      ...
      <p>
        Note that Exoexs has no access to or control over these cookies that are
      ...
      <p>
        Exoexs&apos;s Privacy Policy does not apply to other advertisers or
      ...
      <p>
        Exoexs does not knowingly collect any Personal Identifiable Information
      ...
      <p>
        ...
        shared and/or collect in Exoexs. This policy is not applicable to any
...
export default DeletionPrivacy;
