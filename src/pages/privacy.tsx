...
const privacy = () => {
  return (
    <Section className="space-y-8 pt-20">
      ...
      <ul className="px-4 list-inside list-disc">
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Exoexs.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Exoexs, accessible from{" "}
            <a
              href="https://Exoexs.com"
      ...
      <ul className="px-4 list-inside list-disc">
        <li>
          <p>By email: xwedx00@protonmail.com</p>
        </li>
        <li>
          <p>
            By visiting this page on our website:{" "}
            <a
              href="https://exoexs.com/contact"
              rel="external nofollow noopener noreferrer"
              target="_blank"
            >
              https://Exoexs.com/contact
            </a>
          </p>
        </li>
      </ul>
