...
const ReadPage: NextPage<ReadPageProps> = ({ chapters }) => {
  ...
  // `chapters` is an empty stub until the source backend lands; guard the
  // destructuring defaults so the reader shell renders without crashing.
  const [
    mangaId,
    ...
    >
      <ReadSettingsContextProvider>
        <div className="flex items-center justify-center w-full min-h-screen">
          <Head
            title={`${title} (${currentChapter.name}) - ExoTv`}
