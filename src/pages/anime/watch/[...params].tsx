...
//     <React.Fragment>
//       <Head
//         title={`${title} (${currentEpisode.name}) - Exoexs`}
//         description={`Xem phim ${title} (${currentEpisode.name}) tại Exoexs. Hoàn toàn miễn phí, không quảng cáo`}
...
//       .from<AnimeSourceConnection>("Exoexs_anime_source")
//       .select(
//         `
//           episodes:Exoexs_episodes(*, source:Exoexs_sources(*))
//         `
//       )
